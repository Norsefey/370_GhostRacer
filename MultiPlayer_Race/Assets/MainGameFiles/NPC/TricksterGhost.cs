...
public class TricksterGhost : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        _moveSpeed = WorldStats._finalBaseSpeed;
    ...
    {//respawn at random intervals
        ...
        Vector3 spawnArea = _playerRef.transform.position + (_playerRef.transform.forward * (WorldStats._finalBaseSpeed * 2));
    ...
    void InflictRandomStatus()
    {
        ...
        switch (delta)
        {
            case 0://drains all stamina and makes player exhausted
                ...
                _playerMainMovementScript.CurrentStamina = 0;
                _playerMainMovementScript.Exhausted = true;
