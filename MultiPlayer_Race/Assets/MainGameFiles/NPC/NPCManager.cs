...
public class NPCManager : MonoBehaviour
{
    ...
    void DistanceChecker()
    {
        ...
        if (_AOAIndex < _TargetPoints.ArrayOfArrays.Count && _currentDistance < _minDistance)
        {
        ...
        else if (_AOAIndex >= _TargetPoints.ArrayOfArrays.Count && _currentDistance <= .5)
        {
            _active = false;
        }
    }
